...
export const FlashcardsRandomWords: React.FC = () => {
  ...
  // const { useTimer } = useStatsLevel();
  // useTimer();
  return (
    <div
      className={
        'mt-4 flex flex-col gap-4 lg:ml-10 lg:mr-10 lg:mt-12 lg:grid lg:grid-cols-3 lg:grid-rows-2 lg:gap-4 2xl:ml-32 2xl:mr-32 2xl:mt-14'
      }
    >
